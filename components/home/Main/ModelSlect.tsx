...
const models = [
  { id: "g2.5flash", name: "G2.5Flash", icon: PiLightningFill },
  { id: "g2.5pro", name: "G2.5Pro", icon: PiShootingStarFill }
]
      ...
      {models.map((item) => {
        ...
        return (
          <button 
            ...
            className={`group hover:text-gray-900 hover:dark:text-gray-100 flex justify-center items-center space-x-2 py-2.5 min-w-[148px] text-sm font-bold border rounded-lg ${
              selected 
